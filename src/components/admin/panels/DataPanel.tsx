      ...
      <div className="h-12 px-4 border-b border-border/40 flex justify-between items-center bg-muted/20 shrink-0">
        ...
        <div className="flex gap-1">
          <button
            ...
            className="px-2 py-0.5 rounded-xs hover:bg-muted text-muted-foreground hover:text-foreground transition-colors"
            title="New Post"
          >
        ...
        <div className="space-y-0.5">
          {isLoadingFiles ? (
            <div className="p-4 flex justify-center">
              <span className="icon-[ph--spinner] animate-spin text-muted-foreground size-5"></span>
            </div>
          ) : (
            remoteFiles.map((f) => (
              <div
