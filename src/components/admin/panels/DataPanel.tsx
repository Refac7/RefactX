...
export default function DataPanel() {
  ...
  return (
    ...
    >
      <div className="h-12 px-4 border-b border-outline-variant flex justify-between items-center bg-surface-container shrink-0">
        ...
        <div className="flex gap-1">
          <button
            ...
            className="px-2 py-0.5 rounded-full hover:bg-surface-container-high text-on-surface-variant hover:text-foreground transition-colors"
            title="New Post"
          >
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-2 min-h-0">
        <div className="px-2 py-2 text-[10px] font-mono text-on-surface-variant/50 uppercase tracking-widest">Config Data</div>
              ...
              <div className="flex items-center gap-2.5 overflow-hidden">
                <span
                  className={cn(
                    ...
                    filename === f.name ? 'text-on-primary-container' : 'text-on-surface-variant/60'
                  )}
                />
        ...
        <div className="px-2 py-2 text-[10px] font-mono text-on-surface-variant/50 uppercase tracking-widest border-t border-outline-variant mt-2 pt-4">
          Posts & Articles
        </div>
        <div className="space-y-0.5">
          {isLoadingFiles ? (
            <div className="p-4 flex justify-center">
              <span className="icon-[ph--spinner] animate-spin text-on-surface-variant size-5" />
            </div>
          ) : (
            sortedRemoteFiles.map((f) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-on-surface-variant/40 hover:text-red-500 p-1 hover:bg-red-500/10 rounded-full transition-colors shrink-0"
                  title="Delete"
